  ...
  return (
    ...
    >
      <div className='relative xl:w-2/5 flex flex-col justify-center items-start w-full  max-xl:padding-x pt-28'>
        ...
        <p
        className='font-monsterrat text-slate-gray text-lg leading-8 mt-6 mb-14 sm:max-2-sm'
      ...
      <div key={stat.label}>
        ...
        <p className='leading-7 font-monsterrat text-slate-gray'>
          {stat.label}
        </p>
      </div>
      ) )}
      ...
      <div className=' relative flex-1 flex justify-center items-center xl:min-h-screen max-xl:py-40 bg-primary bg-hero bg-cover bg-center'>
        <img src={bigShoe1} alt="shoeCollection" width={610} height={500} className='object-contain relative z-10' />
      </div>
